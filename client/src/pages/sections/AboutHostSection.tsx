...
export const AboutHostSection = (): JSX.Element => {
  return (
    <section className="relative w-full py-20 overflow-hidden bg-[linear-gradient(180deg,rgba(45,3,3,1)_0%,rgba(89,9,9,1)_50%,rgba(45,3,3,1)_100%)]">
      ...
      {/* Content container */}
      <div className="relative z-10 container mx-auto px-8 lg:px-32 max-w-7xl">
        {/* Section heading */}
        <h2 className="font-sans font-bold text-white text-6xl mb-16 text-center lg:text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col items-center lg:items-start space-y-8">
            <div className="flex items-center space-x-6">
              ...
              />
              <h3 className="font-sans font-bold text-white text-4xl lg:text-5xl leading-tight">
                Sri Sai Ram<br />
